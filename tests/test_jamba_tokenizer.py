...
@pytest.mark.parametrize(
    ...
    argnames=["tokenizer"],
    argvalues=[
        (lazy_fixture("jamba_mini_tokenizer"),),
        (lazy_fixture("jamba_large_tokenizer"),),
    ],
)
...
@pytest.mark.parametrize(
    ...
    argvalues=[
        (27164, "▁hello", lazy_fixture("jamba_mini_tokenizer")),
        (27164, "▁hello", lazy_fixture("jamba_large_tokenizer")),
        ([22560, 2620], ["▁Hello", "▁world"], lazy_fixture("jamba_mini_tokenizer")),
        ([22560, 2620], ["▁Hello", "▁world"], lazy_fixture("jamba_large_tokenizer")),
    ],
)
...
@pytest.mark.parametrize(
    ...
    argvalues=[
        ("▁hello", 27164, lazy_fixture("jamba_mini_tokenizer")),
        ("▁hello", 27164, lazy_fixture("jamba_large_tokenizer")),
        (["▁Hello", "▁world"], [22560, 2620], lazy_fixture("jamba_mini_tokenizer")),
        (["▁Hello", "▁world"], [22560, 2620], lazy_fixture("jamba_large_tokenizer")),
    ],
)
...
@pytest.mark.parametrize(
    ...
    argvalues=[
        ([1, 26928], False, "<|startoftext|>hello", lazy_fixture("jamba_mini_tokenizer")),
        ([1, 26928], False, "<|startoftext|>hello", lazy_fixture("jamba_large_tokenizer")),
        ([1, 26928], True, "hello", lazy_fixture("jamba_mini_tokenizer")),
        ([1, 26928], True, "hello", lazy_fixture("jamba_large_tokenizer")),
    ],
)
...
@pytest.mark.asyncio
async def test_async_tokenizer_encode_decode_mini(async_jamba_mini_tokenizer: AsyncJambaTokenizer):
    text = "Hello world!"
    encoded = await async_jamba_mini_tokenizer.encode(text)
    decoded = await async_jamba_mini_tokenizer.decode(encoded)

    assert decoded == text


@pytest.mark.asyncio
async def test_async_tokenizer_encode_decode_large(async_jamba_large_tokenizer: AsyncJambaTokenizer):
    text = "Hello world!"
    encoded = await async_jamba_large_tokenizer.encode(text)
    decoded = await async_jamba_large_tokenizer.decode(encoded)
...
async def test_async_tokenizer_convert_ids_to_tokens_mini_single_int(
    async_jamba_mini_tokenizer: AsyncJambaTokenizer,
):
    ids = 27164
    expected_tokens = "▁hello"

    actual_tokens = await async_jamba_mini_tokenizer.convert_ids_to_tokens(ids)
...
async def test_async_tokenizer_convert_ids_to_tokens_large_single_int(
    async_jamba_large_tokenizer: AsyncJambaTokenizer,
):
    ids = 27164
    expected_tokens = "▁hello"

    actual_tokens = await async_jamba_large_tokenizer.convert_ids_to_tokens(ids)
...
async def test_async_tokenizer_convert_tokens_to_ids_mini_single_str(
    ...
    actual_ids = await async_jamba_mini_tokenizer.convert_tokens_to_ids(tokens)
...
async def test_async_tokenizer_convert_tokens_to_ids_large_single_str(
    ...
    actual_ids = await async_jamba_large_tokenizer.convert_tokens_to_ids(tokens)
...
async def test_async_tokenizer_decode_with_start_of_line_mini_skip_special_tokens(
    ...
    actual_text = await async_jamba_mini_tokenizer.decode(tokens, skip_special_tokens=skip_special_tokens)
...
async def test_async_tokenizer_decode_with_start_of_line_large_skip_special_tokens(
    ...
    actual_text = await async_jamba_large_tokenizer.decode(tokens, skip_special_tokens=skip_special_tokens)
